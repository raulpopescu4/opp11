...
void Validator::valid_title(const std::string &title) {
...
void Validator::valid_presenter(const std::string &presenter){
...
void Validator::valid_likes(const std::string &likes) {
...
void Validator::valid_link(const std::string &link){
